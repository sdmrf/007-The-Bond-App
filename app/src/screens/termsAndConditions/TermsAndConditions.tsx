...
class TermsAndConditions extends Component<{}, TermsAndConditionsState> {
    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView
          ...
          <Text style={styles.tcL}>
            2. No Misuse Responsibility: we 007-The-Bond expressly disclaims
            any responsibility for the misuse of the App. Users acknowledge that
            they are solely responsible for any consequences or losses incurred
            as a result of their use of the App for purposes other than
            educational.
          </Text>
          <Text style={styles.tcL}>
            3. Acknowledgment of Responsibility: By using the App, you
            acknowledge and agree that you will be personally responsible for
            any loss, damage, or legal consequences resulting from your use of
            the App. we 007-The-Bond will not be held liable for any such
            incidents.
          </Text>
          <Text style={styles.tcL}>
          ...
          <Text style={styles.tcL}>
            6. Termination: we 007-The-Bond reserves the right to terminate
            access to the App at their discretion, without prior notice, if
            users violate these Terms or engage in activities that compromise
